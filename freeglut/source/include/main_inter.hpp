...
#define MAIN_INTER_HPP
	...
	#include <algorithm>
	#include <map>
	#include "./user/console_application.hpp"
	...
	class Interpretator {
		private:
			vvis::console::Console_app_settings settings;
			std::wstring prompt;
		...
		public:
			Interpretator();
			Interpretator(const std::wstring& _PROMPT, const vvis::console::Console_app_settings& settings);
