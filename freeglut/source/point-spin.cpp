...
double vvis::creator::Point::get(wchar_t what) {
	...
	Assert((what == L'x' || what == L'y' || what == 'z'), 301, L"Не x, не y, не z", L"Assert. ФУНКЦИЯ: vvis::creator::Point::get");
...
//
//	Assert((what == L'x' || what == L'y' || what == 'z'), 301, L"Не x, не y, не z", L"Assert. ФУНКЦИЯ: vvis::creator::Point::set");
//
//	switch (what) {
...
double vvis::creator::Spin::get(const std::wstring& what) {
	...
	Assert((what == L"sx" || what == L"sy" || what == L"sz"), 301, L"Не sx, не sy, не sz", L"Assert. ФУНКЦИЯ: vvis::creator::Spin::get");
...
double vvis::creator::Spin::get(wchar_t what) {
	...
	Assert((what == L'x' || what == L'y' || what == 'z'), 301, L"Не x, не y, не z", L"Assert. ФУНКЦИЯ: vvis::creator::Spin::get");
...
double vvis::creator::Spin::set(const std::wstring& what, double& value) {
	...
	Assert((what == L"sx" || what == L"sy" || what == L"sz"), 301, L"Не sx, не sy, не sz", L"Assert. ФУНКЦИЯ: vvis::creator::Spin::set");
...
double vvis::creator::Spin::set(wchar_t what, double& value) {
	...
	Assert((what == L'x' || what == L'y' || what == 'z'), 301, L"Не x, не y, не z", L"Assert. ФУНКЦИЯ: vvis::creator::Spin::set");
